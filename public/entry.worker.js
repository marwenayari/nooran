...
const assets = [
  ...
  "/img/quiz-red.svg",
  "/img/quiz.svg",
  "/img/reading_book.svg",
  "/img/researching.svg",
  "/img/trophy.png",
  "/img/winners.svg",
  "/profile/default.jpg",
  "/profile/marwen.jpeg",
  "/stories/read-bg.jpeg",
  "/locales/ar/auth.json",
  "/locales/ar/common.json",
  "/locales/ar/donate.json",
  "/locales/ar/home.json",
  "/locales/ar/lessons.json",
  "/locales/ar/plans.json",
  "/locales/ar/profile.json",
  "/locales/ar/sidebar.json",
  "/locales/ar/stories.json",
  "/locales/ar/story.json",
  "/locales/en/auth.json",
  "/locales/en/common.json",
  "/locales/en/donate.json",
  "/locales/en/home.json",
  "/locales/en/lessons.json",
  "/locales/en/plans.json",
  "/locales/en/profile.json",
  "/locales/en/sidebar.json",
  "/locales/en/stories.json",
