...
const LessonPage = () => {
    ...
    const answer = () => {
        const correctAnswer = currentChallenge.challenge_options.find((option) => option.correct)
    ...
    const nextQuestion = () => {
        ...
        if (currentQuestionIndex + 1 < currentLesson.challenges.length) {
            ...
            navigate(`/courses/${currentLesson.courses.id}`)
        }
    }
    ...
    return (
        <section className="w-screen h-screen flex flex-col items-center pt-10">
            <div
                ...
                <i onClick={() => {navigate(`/courses/${currentLesson.courses.id}`)}} className="text-3xl text-slate-500 hover:opacity-75 transition cursor-pointer ri-close-large-line"></i>
            ...
            <div className="py-8 w-full flex flex-grow max-w-[768px] mx-auto items-center">
                <div className="block w-full">
                    ...
                    <div className="text-right flex flex-col my-4">
                        {
                            currentChallenge.challenge_options.map(option => (
