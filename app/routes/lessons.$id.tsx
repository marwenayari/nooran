                ...
                <div className="relative  w-1/2">
                  {currentChallenge.audio && (
                    <i
                      ...
                      className="ri-volume-up-line text-2xl w-12 cursor-pointer absolute top-2 right-2 bg-gray-100 p-2 rounded-full flex items-center justify-center"
                    ></i>
                  )}
                  {currentChallenge.imageSource && (
                    <img
                      className="rounded-3xl border-2 border-gray-200 w-54"
                      width="100%"
                      src={currentChallenge.imageSource}
                      alt=""
                    />
                  )}
                </div>
