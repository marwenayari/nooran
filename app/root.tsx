import {json, Links, Meta, Outlet, redirect, Scripts, ScrollRestoration, useLoaderData,} from "@remix-run/react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const fullScreenPaths = ['/lessons']
  const isFullScreen = ['/lessons'].some((value => location.pathname.startsWith(value)))
